                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="/Pemilik/updateData/{{ $kost->id }}" method="POST"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="status" type="text" class="form-control" value="{{ $kost->status }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="rek" type="text" class="form-control" value="{{ $kost->rek }}">
                                    </div>
